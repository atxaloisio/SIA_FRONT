...
export class AppComponent implements OnInit {
  ...
  openLoginDialog(): void {
    ...
    dialogLoginRef.afterClosed().subscribe(result => {
      ...
      if (result.Usuario != null && result.Usuario !== undefined) {
        ...
        sessionStorage.setItem('Perfil', JSON.stringify(this.perfil ));
  ...
  //     JSON.parse(sessionStorage.getItem('Perfil')).cadastros
  //   );
  //   p.cadastros_servico = booleanToStrSN(
  //     JSON.parse(sessionStorage.getItem('cadastros_servico')).cadastros_servico
  //   );
  //   p.cadastros_centro_custo = booleanToStrSN(
  //     JSON.parse(sessionStorage.getItem('cadastros_centro_custo')).cadastros_centro_custo
  //   );
