...
export class DsCentroCusto extends DataSource<CentroCusto> {
  _filterChange = new BehaviorSubject( {id: '', descricao: ''} );

  public onChange: EventEmitter<boolean> = new EventEmitter<boolean>();

  get filter(): CentroCustoFilter {
    return this._filterChange.value;
  }

  set filter(filter: CentroCustoFilter) {
  ...
  connect(): Observable<CentroCusto[]> {
    ...
    .switchMap(() => {
      ...
      return this._centrocustoService.getCentroCustos(this._tokenManager.retrieve(),
