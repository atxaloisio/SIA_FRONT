...
import { Equipamento, EquipamentoFilter } from './equipamento';

export class DsEquipamento extends DataSource<Equipamento> {
  _filterChange = new BehaviorSubject( {id: '', descricao: ''} );

  public onChange: EventEmitter<boolean> = new EventEmitter<boolean>();

  get filter(): EquipamentoFilter {
    return this._filterChange.value;
  }

  set filter(filter: EquipamentoFilter) {
  ...
  connect(): Observable<Equipamento[]> {
    ...
    .switchMap(() => {
      ...
      return this._equipamentoService.getEquipamentos(this._tokenManager.retrieve(),
