...
@Component({
  selector: 'app-filtrocliente-form',
  templateUrl: './filtrocliente-form.component.html',
  styleUrls: ['./filtrocliente-form.component.css']
})
export class FiltroClienteFormComponent implements OnInit, AfterViewInit, AfterViewChecked {
  ...
  btnFiltrar_click() {
    if (this.validaCampos()) {
      this._router.navigate(['/relatorios/clientereport', {
