...
@Component({
  selector: 'app-relatoriofornecedor-form',
  templateUrl: './relatoriofornecedor-form.component.html',
  styleUrls: ['./relatoriofornecedor-form.component.css'],
  encapsulation: ViewEncapsulation.None
})
export class RelatorioFornecedorFormComponent implements OnInit, AfterViewInit, AfterViewChecked {
  ...
  ngOnInit() {
    ...
    this.fornecedores = this._relatorioService.Fornecedores;
