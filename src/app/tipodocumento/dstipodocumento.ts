...
export class DsTipoDocumento extends DataSource<TipoDocumento> {
  _filterChange = new BehaviorSubject( {id: '', descricao: ''} );

  public onChange: EventEmitter<boolean> = new EventEmitter<boolean>();

  get filter(): TipoDocumentoFilter {
    return this._filterChange.value;
  }

  set filter(filter: TipoDocumentoFilter) {
  ...
  connect(): Observable<TipoDocumento[]> {
    ...
    .switchMap(() => {
      ...
      return this._tipodocumentoService.getTipoDocumentos(this._tokenManager.retrieve(),
